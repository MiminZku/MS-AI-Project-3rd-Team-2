...
async def run_simulation_for_all():
    ...
    for idx, p in enumerate(PERSONAS, start=1):
        ...
        interview_doc = {
            ...
            "video_recording_url": f"https://staiitvteam2.blob.core.windows.net/recordings/{p['id']}/full_video.webm",
            "audio_recording_url": f"https://staiitvteam2.blob.core.windows.net/recordings/{p['id']}/audio_only.mp3",
